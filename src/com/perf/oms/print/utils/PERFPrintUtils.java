...
public class PERFPrintUtils {
	
	private static String MODULE_WIDTH = "0.21mm";
	...
	public String genBarCodetag(String documentNumber, String bcType, String imageType
			) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String genBarcodeImageString(String documentNumber, String bcType, String imageType
			) throws Exception {
	 ...
	 */
	private String getConfiguration(String bcType) {
